// Generated by Bisonc++ V6.03.00 on Thu, 03 Feb 2022 10:06:01 +0100
...
PI_ const s_productionInfo[] = 
{
     ...
     {321, 2}, // 24: statement (';') ->  expression ';'
     {321, 1}, // 25: statement ->  scope_block
     {321, 5}, // 26: statement (INLINE_BF) ->  INLINE_BF '(' STR ')' ';'
     {321, 5}, // 27: statement (MOVE_PTR) ->  MOVE_PTR '(' IDENT ')' ';'
     {321, 1}, // 28: statement ->  for_statement
     {321, 1}, // 29: statement ->  if_statement
     {321, 1}, // 30: statement ->  while_statement
     {323, 1}, // 31: expression ->  variable_declaration
     {323, 1}, // 32: expression ->  variable
     {323, 1}, // 33: expression ->  array_element
     {323, 1}, // 34: expression ->  constant_literal
     {323, 1}, // 35: expression ->  string_literal
     {323, 1}, // 36: expression ->  anonymous_array
     {323, 1}, // 37: expression ->  function_call
     {323, 4}, // 38: expression (SIZEOF) ->  SIZEOF '(' IDENT ')'
     {323, 3}, // 39: expression ('=') ->  variable_declaration '=' expression
     ...
     {326, 2}, // 83: variable_declaration (LET) ->  LET variable_specification
     {327, 1}, // 84: variable_specification (IDENT) ->  IDENT
     {327, 3}, // 85: variable_specification ('[') ->  '[' ']' IDENT
     {327, 4}, // 86: variable_specification ('[') ->  '[' NUM ']' IDENT
     {327, 4}, // 87: variable_specification ('[') ->  '[' IDENT ']' IDENT
     {328, 1}, // 88: variable_specification_list ->  variable_specification
     {328, 3}, // 89: variable_specification_list (',') ->  variable_specification_list ',' variable_specification
     {329, 1}, // 90: variable (IDENT) ->  IDENT
     {330, 1}, // 91: constant_literal (NUM) ->  NUM
     {330, 1}, // 92: constant_literal (CHR) ->  CHR
     {331, 1}, // 93: expression_list ->  expression
     {331, 3}, // 94: expression_list (',') ->  expression_list ',' expression
     {332, 0}, // 95: optional_expression_list ->  <empty>
     {332, 1}, // 96: optional_expression_list ->  expression_list
     {333, 4}, // 97: array_element (IDENT) ->  IDENT '[' expression ']'
     {334, 1}, // 98: string_literal (STR) ->  STR
     {335, 4}, // 99: anonymous_array ('#') ->  '#' '(' expression_list ')'
     {335, 4}, // 100: anonymous_array ('#') ->  '#' '[' NUM ']'
     {335, 4}, // 101: anonymous_array ('#') ->  '#' '[' IDENT ']'
     {335, 6}, // 102: anonymous_array ('#') ->  '#' '[' NUM ',' expression ']'
     {335, 6}, // 103: anonymous_array ('#') ->  '#' '[' IDENT ',' expression ']'
     {336, 4}, // 104: function_call (IDENT) ->  IDENT '(' optional_expression_list ')'
     {337, 1}, // 105: program_$ ->  program
};
...
SR_ s_21[] =
{
    ...
    { {     260}, { 35} }, // INLINE_BF           
    { {     261}, { 36} }, // MOVE_PTR            
    { {     324}, { 37} }, // for_statement       
    { {     325}, { 38} }, // if_statement        
    { {     322}, { 39} }, // while_statement     
    { {     326}, { 40} }, // variable_declaration
    { {     329}, { 41} }, // variable            
    { {     333}, { 42} }, // array_element       
    { {     330}, { 43} }, // constant_literal    
    { {     334}, { 44} }, // string_literal      
    { {     335}, { 45} }, // anonymous_array     
    { {     336}, { 46} }, // function_call       
    { {     263}, { 47} }, // SIZEOF              
    { {      40}, { 48} }, // '('                 
    { {     283}, { 49} }, // INC                 
    { {     284}, { 50} }, // DEC                 
...
{
    { { REQ_DEF}, {   6} },                           
    { {     319}, {  67} }, // optional_parameter_list
    { {     318}, {  68} }, // parameter_list         
    { {     317}, {  69} }, // parameter              
    { {     285}, {  70} }, // IDENT                  
    { {      38}, {  71} }, // '&'                    
    { {       0}, { -19} },                           
...
{
    { { REQ_TOKEN}, {   4} },                          
    { {       327}, { 122} }, // variable_specification
    { {       285}, {  16} }, // IDENT                 
    { {        91}, {  17} }, // '['                   
    { {         0}, {   0} },                          
};
...
{
    { { REQ_DEF}, {  22} },                            
    { {     332}, { 173} }, // optional_expression_list
    { {     331}, { 174} }, // expression_list         
    { {     323}, { 175} }, // expression              
    { {     326}, {  40} }, // variable_declaration    
    { {     329}, {  41} }, // variable                
    { {     333}, {  42} }, // array_element           
...
{
    { { REQ_DEF}, {   6} },                           
    { {     319}, { 180} }, // optional_parameter_list
    { {     318}, {  68} }, // parameter_list         
    { {     317}, {  69} }, // parameter              
    { {     285}, {  70} }, // IDENT                  
    { {      38}, {  71} }, // '&'                    
