...
template <>
struct TagOf<std::vector<std::pair<std::string, TypeSystem::Type>>>
{
...
template <>
struct TagOf<std::pair<std::string, TypeSystem::Type>>
{
...
template <>
struct TagOf<std::tuple<std::string, std::string, std::string>>
{
...
template <>
struct TypeOf<Tag_::STRING_LIST>
{
...
// $insert polymorphicOpAssignDecl
        ...
        SType &operator=(std::vector<std::tuple<std::string, std::string, std::string>> const &value);
...
inline SType &SType::operator=(std::vector<std::pair<std::string, TypeSystem::Type>> const &value)
{
    assign< Tag_::DECLARATION_LIST >(value);
    return *this;
}
inline SType &SType::operator=(std::vector<std::pair<std::string, TypeSystem::Type>> &&tmp)
{
...
inline SType &SType::operator=(std::vector<std::tuple<std::string, std::string, std::string>> const &value)
{
    assign< Tag_::TEST_VECTOR >(value);
    return *this;
}
inline SType &SType::operator=(std::vector<std::tuple<std::string, std::string, std::string>> &&tmp)
{
    assign< Tag_::TEST_VECTOR >(std::move(tmp));
    return *this;
}
inline SType &SType::operator=(std::tuple<std::string, std::string, std::string> const &value)
{
